use shared::{AuthSession, ChangePassword, Credentials, Invitation, InviteStatus, InvitesOverview};
        ...
        <div class="screen sb-scroll">
            ...
            if let Some(session) = &props.auth {
                ...
                <div class="account-card">
                    ...
                    {password_field(cur_pw.clone(), *show_cur, toggle_show_cur.clone())}
                    <div class="field-label">{"New password"}</div>
                    {password_field(new_pw.clone(), *show_new, toggle_show_new.clone())}
                    <div class="field-label">{"Confirm new password"}</div>
                    {password_field(confirm_pw.clone(), *show_confirm, toggle_show_confirm.clone())}
                    <button
                        class="submit-btn"
