# TODO
- Add a FamilyName, GivenName to the account profile, set by the user them selves
- Change the invitation logic: Let new users invite 25 people per day immediately, and 100 people per day after 24 hours
- Let users revoke invite codes that they have sent
- Add a share button to places that shares the URI for a place


# BACKLOG (Don't do the tasks below yet)
- Show logs of changes to places 
